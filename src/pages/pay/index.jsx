...
class Pay extends Component {
  ...
  componentDidMount() {
    ...
    getUnlockPrice().then((data) => {
      if (data.statusCode == 200) {
        this.setState({
          photoPrice: data.data.data.photo,
          wxPrice: data.data.data.account,
          loading: false,
        });
      } else {
        Toast.fail({
                            ...
                            payCallBack({
                              ...
                              .then((data) => {
                                if (data.data.status === 200) {
                                  ...
                                  if (
                                    this.props.route.params.goodsType === "2"
                                  ) {
                                    ...
                                    this.props.route.params.goodsType === "1"
                                  ) {
                                    Taro.eventCenter.trigger(
                                      "payPhotoStatus",
                                      true
            ...
            <WingBlank size="lg">
              <Card.Body>
                <View className="topContent">
                  ...
                  <Text style={{ fontSize: 16, color: "#f6386f" }}>
                    <Text style={styles.sumMoney}>
                      {this.props.route.params.goodsType == 2
                        ? this.state.wxPrice
                        : this.state.photoPrice}
                    </Text>
                    元
                  </Text>
              ...
              <Card.Body>
                ...
                >
                  <View className="payContentType">
                    <Image src={wxImg} style={{ width: 40, height: 40 }} />
